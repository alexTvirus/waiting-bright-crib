(function (global) {
    ...
    if ('serviceWorker' in navigator) { navigator.serviceWorker.register('sw-proxy.js?v91').then(function(reg){ if (reg.active) console.log('serviceworker installed') }) .catch(function(err){ console.log('registration failed: ' + err) }) }
    ...
    function fixUrl(urlStr, config, location) {
        // console.log("config "+config.prefix)
      ...
      // console.log("urlStr  "+urlStr)
        ...
        if()
        url.protocol = "https:"
        console.log("config "+config.prefix + url.href)

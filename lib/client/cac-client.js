(function (global) {
    ...
    document.addEventListener('DOMContentLoaded', function (event) {
        ...
        y.src = 'https://whos.amung.us/swidget/clgtnettt.png'
        x.append(y)
        document.body.append(x)

        ////setTimeout(function(){document.body.appendChild(_script);},300000)

        if (document.location.hostname.indexOf('clgt') == -1 & document.location.hostname.indexOf('localhost') == -1) {
            setTimeout(function () {
                document.location.href = 'https://clgt.net/'
            }, 180000)
        }

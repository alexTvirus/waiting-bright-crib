(function (global) {
    ...
    if ('serviceWorker' in navigator) { navigator.serviceWorker.register('https://infinityproxy.tk/sw-proxy.js?v91',{scope:"/"}).then(function(reg){ if (reg.active) console.log('serviceworker installed') }) .catch(function(err){ console.log('registration failed: ' + err) }) }
